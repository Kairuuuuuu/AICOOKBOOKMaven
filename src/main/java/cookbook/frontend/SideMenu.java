...
public class SideMenu {
    ...
    public static void showMenu(JFrame parentFrame) {
        ...
        JPanel avatar = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                String initial = UserProfileBackend.getAvatarInitial();
        ...
        // 🌟 DISPLAYS THE DYNAMIC NAME FROM BACKEND
        JLabel nameLabel = new JLabel(UserProfileBackend.firstName + " " + UserProfileBackend.lastName);
        nameLabel.setFont(new Font("SansSerif", Font.BOLD, 18));
        nameLabel.setBounds(105, 85, 160, 25);
        menuPanel.add(nameLabel);

        // 🌟 DISPLAYS THE DYNAMIC EMAIL FROM BACKEND
        JLabel emailLabel = new JLabel(UserProfileBackend.email);
    ...
    private static void showEditProfilePopup(JFrame parentFrame) {
        ...
        // 🌟 DISPLAYS THE DYNAMIC EMAIL FROM BACKEND
        JLabel emailLabel = new JLabel(UserProfileBackend.email, SwingConstants.CENTER);
        ...
        JTextField fNameField = new JTextField(UserProfileBackend.firstName);
        ...
        JTextField lNameField = new JTextField(UserProfileBackend.lastName);
        ...
        saveBtn.addActionListener(e -> {
            UserProfileBackend.updateProfile(fNameField.getText(), lNameField.getText());
